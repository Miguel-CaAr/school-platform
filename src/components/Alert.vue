...
<template>
  <main v-if="showModal" class="background">
    <!-- Modal panel -->
    <div
      class="w-full mx-auto inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
      role="dialog"
      aria-modal="true"
