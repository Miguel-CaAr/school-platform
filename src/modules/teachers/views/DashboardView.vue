...
<template>
  ...
  <div>
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white text-black">
      ...
      <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
        ...
        <div class="flex justify-between items-center h-14 bg-blue-800 header-right">
          <div class="bg-blue-800rounded flex items-center w-full max-w-xl mr-4 p-2 shadow-sm border border-blue-800">
          ...
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
              <a @click="openEnrollModal" href="#"
                ...
                <span class="ml-2 text-sm tracking-wide truncate">Inscribir en curso</span>
              </a>
            </li>
            <!-- <li>
              <a
            ...
            <li>
              <a href="#"
                ...
                <span class="ml-2 text-sm tracking-wide truncate">Configuracion</span>
              </a>
            </li>
          </ul>
      ...
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 p-4 gap-4">
          <button @click="buttonCreateCourse"
              ...
              <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="SVGRepo_iconCarrier">
                  <path
                    ...
                    stroke="#1E40AF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                </g>
              </svg>
            </div>
            <!-- agregar a  -->
          ...
          <button @click="buttonCreateStudent"
            class="cursor-pointer bg-blue-500 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 text-white font-medium group">
            <div
              class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
              <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <CreateStudents />
    <Enroll />
    <Alert :show-modal="alertStore.show" :success="alertStore.success" :title="alertStore.title"
      :message="alertStore.message" @on-update-modal="onCloseModal" />
  </div>
</template>
