            ...
            <div class="rounded-t mb-0 px-0 border-0">
              ...
              <div class="block w-full">
                ...
                <ul class="my-1">
                  <li class="flex px-4">
                    <div
                      class="w-9 h-9 rounded-full flex-shrink-0 bg-green-500 my-2 mr-3"
                    >
                      <svg
        ...
        >
          ...
          <div class="md:col-span-2 xl:col-span-1">
            <div class="rounded bg-gray-200 dark:bg-gray-800 p-3">
              <div
                class="flex justify-between py-1 text-black dark:text-white"
              >
            ...
            <div class="rounded bg-gray-200 dark:bg-gray-800 p-3">
              ...
              <div class="text-sm text-black dark:text-gray-50 mt-2">
                ...
                >
                  Do a mobile first layout
                  <div
                    class="flex justify-between items-start mt-2 ml-2 text-white text-xs"
                  >
                    <span
                      class="bg-pink-600 rounded p-1 text-xs flex items-center"
                    >
                      <svg
